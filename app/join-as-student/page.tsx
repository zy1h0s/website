        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-10">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: EASE }} className="max-w-2xl">
            <span className="inline-flex items-center gap-2.5 text-[12px] font-semibold uppercase tracking-[0.15em] text-white/30 mb-5">
              <span className="w-6 h-px bg-accent/50" />For Students
            </span>
            ...
            <div className="lg:col-span-4 lg:col-start-9">
              <div className="lg:sticky lg:top-28 space-y-10">
                <div className="space-y-6">
                  {[
                    { label: 'Program duration', value: 'Flexible, mentor-led' },
                    { label: 'Cost to students', value: 'Completely free' },
                    { label: 'Session format', value: 'Live, 1-on-1 or small group' },
                  ].map((item, i) => (
                    <motion.div
                      key={item.label}
                ...
                <div className="border-t border-dark/[0.06] pt-8">
                  <p className="text-[13px] font-semibold text-dark/40 mb-4">What you will gain</p>
                  <div className="space-y-4">
                    {[
                      'Real-world skills from working professionals',
                      'Hands-on projects and practical experience',
                      'Industry connections and career guidance',
                    ].map((text, i) => (
