...
export default function CandidateSettingsPage() {
  ...
  return (
    <DashboardPageShell role="candidate" title="Settings" description="Manage your profile and preferences.">
      <div className="max-w-2xl">
        <form onSubmit={handleSave} className="rounded-2xl bg-white ring-1 ring-dark/[0.05] p-6 sm:p-8 space-y-6">
          ...
          <div className="flex items-center gap-3 pt-2">
            <Button type="submit" variant="dark" size="md" icon={<Save className="w-3.5 h-3.5" />} iconPosition="left">
        ...
        <div className="rounded-2xl bg-white ring-1 ring-dark/[0.05] p-6 sm:p-8 mt-6">
          <h3 className="text-[14px] font-bold text-dark mb-4">Preferences</h3>
          <div className="space-y-4">
            {['Email notifications for new applications', 'Weekly progress report', 'Session reminders (1 hour before)'].map((pref, i) => (
